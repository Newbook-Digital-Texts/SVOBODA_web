...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: august.carow@gmail.com' . "\r\n";
// sends bcc to alternate address

//Creates intelligible subject line that shows where it came from
$subject = 'Svoboda Diaries Project Inquiry'; // if your client has more than one web site, you can put the site name here.
...
mail ('walter@uw.edu', $subject, $body, $from);
